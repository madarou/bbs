...
public class ArticleCrawler_DZKD extends ArticleCrawler
{
  public ArticleCrawler_DZKD(Queue<ArticleInfo> queue, Configure.SleepTime sleeptime)
  {
...
protected String getJobContent(ArticleInfo article)
    throws ClientProtocolException, ClassNotFoundException, IOException, InterruptedException
  {
    ...
    String html = this.crawler.getHtml(article.getUrl());
    Document doc = Jsoup.parse(html);
    Elements tds = doc.select("td[class=tznr]");
  ...
  {
    return Constants.BBSTYPE.DZKD.toString();
  }
  
  public static void main(String[] args){
	  File input = new File("C:/Users/ZYR/Desktop/dzkd_detail.html");
	  Document doc=null;
	  String content = null;
		try {
