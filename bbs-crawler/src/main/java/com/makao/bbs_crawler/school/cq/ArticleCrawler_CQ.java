...
public class ArticleCrawler_CQ extends ArticleCrawler
{
  public ArticleCrawler_CQ(Queue<ArticleInfo> queue, Configure.SleepTime sleeptime)
  {
...
protected String getJobContent(ArticleInfo article)
  ...
  {
    return Constants.BBSTYPE.CQ.toString();
  }
