...
public class ArticleCrawler_XNDX extends ArticleCrawler
{
  public ArticleCrawler_XNDX(Queue<ArticleInfo> queue, Configure.SleepTime sleeptime)
  {
...
protected String getJobContent(ArticleInfo article)
  ...
  {
    return Constants.BBSTYPE.XNDX.toString();
  }
